...
function loadStatsPage() {
	...
	changeWin.innerHTML += win;
	var changeLoss = document.getElementById("losses");
	changeLoss.innerHTML += loss;
}
/*
...
function loadPlayersPage()
{
	...
	for(i = 0; i<players.length;i++)
	{
		...
		anchor = anchor + "<a class = 'dropdown-item' href='#' onclick = 'switchPlayers("+ i +")'>" + player +"</a>"
	}
	playerselect.innerHTML=anchor;
...
function switchPlayers(playerNum)
{
	...
	var passingyards = Math.floor(players[playerNum].pass_yards/players[playerNum].games_played);
	var rushingyards = Math.floor(players[playerNum].rushing_yards/players[playerNum].games_played);
	var recievingyards = Math.floor(players[playerNum].receiving_yards/players[playerNum].games_played);
	
	document.getElementById("avg_p_yards").innerHTML = passingyards;
	document.getElementById("avg_r_yards").innerHTML = rushingyards;
    document.getElementById("avg_rec_yards").innerHTML = recievingyards;
